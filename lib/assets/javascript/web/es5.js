(function () {
  ...
  function _postMessage(jsonData) {
      console.log('WebViewJavascriptBridge: postMessage ', jsonData);
      var jsonStr = JSON.stringify(jsonData);
      var encodeStr = encodeURIComponent(jsonStr);
      window.top.postMessage(encodeStr,'*');
  }
  ...
  setTimeout(() => {
      ...
      var jobs = window.WVJSBCallbacks || [];
      readyEvent.initEvent('WebViewJavascriptBridgeReady');
      readyEvent.bridge = WebViewJavascriptBridge;
      delete window.WVJSBCallbacks;
